...
public class DialogFragment extends Fragment implements OnClickListener {
	...
	private void createItems() {
	    mPanel.setBackgroundColor(getResources().getColor(R.color.white));
	...
	public void setFragmentListner(IDialogCallBack listener) {
		mListener = listener;
	}
	...
	public static class Builder {
		...
		public Builder setListener(IDialogCallBack listener) {
		...
		public DialogFragment show() {
			DialogFragment actionSheet = (DialogFragment) Fragment.instantiate(
				  mContext, DialogFragment.class.getName(), prepareArguments());
			actionSheet.setFragmentListner(mListener);
	...
	public static interface IDialogCallBack {
		...
		void onDismiss(DialogFragment dialogFragment, boolean isCancel);

		void onOtherButtonClick(DialogFragment dialogFragment, int index);
	}
